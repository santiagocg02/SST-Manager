...
<div class="page-wrap">
    <div class="topbar">
        ...
        <div class="topbar-right">
            <span class="badge-format">Formato 2.10.1 · RE-SST-16</span>
        </div>
    </div>

    <div class="sheet-card">
        <div class="sheet-header">
            <h1 class="sheet-header-title">Lista de chequeo para verificación de requerimientos generales del SG-SST para persona natural</h1>
            ...
            <div class="sheet">
                <table class="form-sheet">
                    ...
                    <tr>
                        ...
                        <td class="top-cell">RE-SST-16</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="info-field" colspan="3"><input type="text" name="fecha" value=""></td>
                        <td class="info-label"> </td>
                        <td class="info-field"><input type="text" value=""></td>
                    </tr>
                    <tr>
                        <td class="info-label">Nombre del contratista</td>
                        <td class="info-field" colspan="2"><input type="text" name="contratista" value=""></td>
                        <td class="info-label">Nit:</td>
                        <td class="info-field" colspan="2"><input type="text" name="nit" value=""></td>
                    </tr>
                    <tr>
                        <td class="info-label">Nombre del Supervisor</td>
                        <td class="info-field" colspan="2"><input type="text" name="supervisor" value=""></td>
                        <td class="info-label">CC</td>
                        <td class="info-field" colspan="2"><input type="text" name="cc" value=""></td>
                    </tr>

                    <tr>
                        <td colspan="6" class="instruction">
                            . Cuando sean seleccionados y con los demás documentos exigidos por la sección de contratación o quien haga sus veces, el contratista debe cumplir con los siguientes requerimientos:
                        </td>
                    </tr>
