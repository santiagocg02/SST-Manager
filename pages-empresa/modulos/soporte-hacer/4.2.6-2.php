...
$idItem = isset($_GET['item']) ? (int)$_GET['item'] : 56;
...
$datos = [
    ...
    'observacion_general' => oldv('observacion_general', 'Especial para proteger a la exposición a partículas de sustancias especificadas por OSHA, vapores orgánicos, material particulado, humos metálicos y trabajos en alturas.'),
];
    ...
    <div class="contenido">
        <form id="form4262">
            ...
            <div class="nota-box">
                ...
                <textarea name="observacion_general" style="height:auto; min-height:40px;"><?php echo htmlspecialchars($datos['observacion_general'], ENT_QUOTES, 'UTF-8'); ?></textarea>
            </div>
        </form>
    </div>
</div>
...
document.getElementById('btnGuardar').addEventListener('click', async function() {
    const btn = this;
    const form = document.getElementById('form4262');
