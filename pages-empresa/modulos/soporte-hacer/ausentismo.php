...
// Ajusta el ID de este ítem según tu base de datos para Ausentismo
...
// Función modificada para leer de los datos guardados en BD en lugar de POST
...
// Calcular cuántas filas de detalle existen guardadas en la base de datos
$filasDetalle = 1;
if (!empty($datosCampos)) {
    foreach($datosCampos as $k => $v) {
        if (preg_match('/^det_nombre_(\d+)$/', $k, $matches)) {
            $num = (int)$matches[1];
            if ($num > $filasDetalle) {
                $filasDetalle = $num;
            }
...
<head>
    ...
    <style>
        *{box-sizing:border-box;margin:0;padding:0;font-family:Arial, Helvetica, sans-serif;}
        ...
        .encabezado td,.encabezado th{text-align:center; vertical-align:middle;}
        .logo-box{
...
<div class="contenedor">
    ...
    <div class="formulario">
        <form id="formAusentismo">
            ...
            <div class="nota">Nota: Ingrese número de trabajadores, total de días trabajados y % de ausentismos del año anterior. Solo diligencie las filas azules.</div>
            ...
            <div class="nota">Nota: ingrese el Nombre, cédula, digite la fecha, días de ausentismo según causa. Solo diligencie las celdas con líneas azules.</div>
            ...
            <div class="nota">Nota: todas las celdas se calculan automáticas, no ingresar datos.</div>
...
document.getElementById('btnGuardar').addEventListener('click', async function() {
    const btn = this;
    const form = document.getElementById('formAusentismo');
    ...
    try {
        ...
        if (result.ok) {
            Swal.fire({
                title: '¡Éxito!',
                text: 'Los datos del ausentismo fueron guardados correctamente.',
                icon: 'success',
