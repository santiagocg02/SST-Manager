...
<div class="layout">
    ...
    <div class="soft-card left-panel">
        ...
        <div class="left-sub">
            Implementación y ejecución del SG-SST
        </div>
    ...
    <div class="topbar">
        ...
        <div class="topbar-left">
            <h2>Implementación y ejecución  del SG SST </h2>
    ...
    <div class="soft-card right-panel">
        ...
        <div class="resume-item">
            <div class="resume-left">
                ...
                <div>Gestión de Peligros y Riesgos</div>
            </div>
...
document.addEventListener("click",(e)=>{
    ...
    if(btn && btn.dataset.file){
        // Mantiene la ruta ajustada a la carpeta correspondiente a 'Hacer'
        frame.src = `./soporte-hacer/${btn.dataset.file}`;
        drawer.show();
