...
const pesvItems = [
    ...
    { paso:"3", actividad:"Política de Seguridad Vial de la organización", soporte:"pesv-3.php", isHeader:false },
    { paso:"4", actividad:"Liderazgo, compromiso y corresponsabilidad del nivel directivo", soporte:"pesv-4.php", isHeader:false },
    { paso:"", actividad:"Presupuesto", soporte:"pesv-4-2.php", isHeader:false },
    { paso:"5", actividad:"Diagnostico PESV", soporte:"pesv-5.php", isHeader:false },
    { paso:"", actividad:"Caracterización para la identificación de los riesgos viales", soporte:"pesv-5-2.php", isHeader:false },
    { paso:"", actividad:"Tabulación y análisis de la Caracterización", soporte:"pesv-5-3.php", isHeader:false },
    { paso:"", actividad:"Lista de propios, terceros y contratistas", soporte:"pesv-5-4.php", isHeader:false },
    { paso:"", actividad:"Lista de rutas frecuentes", soporte:"pesv-5-5.php", isHeader:false },
    { paso:"", actividad:"Lista de personal de la organización", soporte:"pesv-5-6.php", isHeader:false },
    { paso:"6", actividad:"Caracterización, evaluación y control de riesgos", soporte:"pesv-6.php", isHeader:false },
    { paso:"", actividad:"Procedimiento para la identificación de los riesgos viales", soporte:"pesv-6-2.php", isHeader:false },
    { paso:"", actividad:"Identificación de los riesgos viales", soporte:"pesv-6-3.php", isHeader:false },
    { paso:"", actividad:"Caracterización de la accidentalidad y análisis", soporte:"pesv-6-4.php", isHeader:false },
    { paso:"7", actividad:"Objetivos y metas del PESV", soporte:"pesv-7.php", isHeader:false },
    { paso:"8", actividad:"Programas de Gestión de riesgos críticos y factores de desempeño", soporte:"pesv-8.php", isHeader:false }
];
