...
<title>SSTMANAGER - PESV ACTUAR</title>
...
<div class="layout">
    ...
    <div class="soft-card left-panel">
        ...
        <div class="left-sub">
            Acciones de Mejora y Comunicación
        </div>
    ...
    <div class="soft-card right-panel">
        ...
        <div class="resume-item">
            <div class="resume-left">
                ...
                <div>Comunicación y Reportes</div>
            </div>
            <div class="resume-check"></div>
        </div>
        ...
        <div class="resume-item">
            <div class="resume-left">
                ...
                <div>Evaluación de Desempeño</div>
            </div>
            <div class="resume-check"></div>
        </div>
...
const pesvItems = [
    ...
    { paso:"24", actividad:"Mecanismos de comunicación y participación", soporte:"", isHeader:true },
    { paso:"", actividad:"Mecanismos de comunicación y participación", soporte:"actuar-24-1.php", isHeader:false },
    { paso:"", actividad:"Reporte de actos y condiciones inseguras", soporte:"actuar-24-2.php", isHeader:false },
    { paso:"", actividad:"Procedimiento de evaluación de desempeño", soporte:"actuar-24-3.php", isHeader:false },
    { paso:"", actividad:"Evaluación de desempeño", soporte:"actuar-24-4.php", isHeader:false }
];
